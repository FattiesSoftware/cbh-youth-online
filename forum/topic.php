...
">
   	<div class="topic">
	<p style="display:<?=$NOTICE?>">Đăng nhập để trả lời và bày tỏ cảm xúc đối với bài viết này</p>
      <div class="topic-info" style="display:<?=$OUT?>">
